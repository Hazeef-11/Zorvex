...
const Sunglasses_product = () => {
  const { data,loading } = useApi("https://zorvex-api.onrender.com/sunglasses");
  ...
  return (
    <div className="bg-slate-50">
      <div className="py-5">
        <p className="text-4xl font-bold text-center">Sunglasses</p>
        <p className="text-2xl text-center mt-3">
          Protect your eyes while elevating your everyday look
        </p>
      </div>
...
export default Sunglasses_product;
