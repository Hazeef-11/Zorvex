...
const Womens_product = () => {
  const { data,loading } = useApi("https://zorvex-api.onrender.com/womensFashion");
  ...
  return (
    <div className="bg-slate-50">
      <div className="py-5">
        <p className="text-4xl font-bold text-center">Women's Fashion</p>
        <p className="text-2xl text-center mt-3">
          Discover effortless elegance with modern women’s fashion
        </p>
      </div>
