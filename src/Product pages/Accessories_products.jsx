...
const Accessories_products = () => {
  const { data,loading } = useApi("https://zorvex-api.onrender.com/accessories");
  ...
  return (
    <div className="bg-slate-50 ">
      <div className="py-5">
        <p className="text-4xl font-bold text-center">Accessories</p>
        <p className="text-2xl text-center mt-3">
          Complete your look with stylish everyday accessories
        </p>
      </div>
...
export default Accessories_products;
