...
const Mens_product = () => {
  ...
  const { data,loading} = useApi("https://zorvex-api.onrender.com/mensFashion");
  console.log(text);
  ...
  return (
    <div className="bg-slate-50 ">
      <div className="py-5 ">
        <p className="text-4xl font-bold text-center">Men's Fashion</p>
        <p className="text-2xl text-center mt-3">
          Elevate your everyday style with timeless men’s fashion
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 place-items-center pb-20  ">
        {search.map((product) => (
          <div className="h-110 w-80 bg-[#EBC0A0] rounded-md overflow-hidden mt-10 border-3 hover:scale-105 duration-500 mb-10 shadow-[0_8px_25px_rgba(0,0,0,0.08)]">
            <div className="h-60 w-80 bg-black  overflow-hidden   border-b-3 ">
              <img
