...
const Footwear_products = () => {
  const { data,loading } = useApi("https://zorvex-api.onrender.com/footwear");
  ...
  return (
    <div className="bg-slate-50">
      <div className="py-5">
        <p className="text-4xl font-bold text-center">Footwears</p>
        <p className="text-2xl text-center mt-3">
          Step into comfort and style with footwear made for you
        </p>
      </div>
...
export default Footwear_products;
